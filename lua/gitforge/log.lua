...
function GHIssue.notify_change(what_happened)
...
---@param what_happened string Human readable information on what changed.
function GHIssue.notify_failure(what_happened)
...
function GHIssue.ephemeral_info(info_msg)
